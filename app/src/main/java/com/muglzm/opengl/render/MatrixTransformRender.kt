...
class MatrixTransformRender(xRotate: Float, yRotate: Float, xyscale: Float) :GLSurfaceView.Renderer,getMatrixCallback,OnParameterChangeCallback{
    var Rotate_X = 0.0f
    var Rotate_Y = 0.0f
    var ScaleXY = 1f
...
//            // Left face
    ...
    var ratio = 0.0f
    val MATH_PI = 3.1415926535897932384626433832802
    fun setX(xRotateAngle: Int){

        Rotate_X = (MATH_PI/180.0f * (xRotateAngle % 360)).toFloat()
        Log.d(MyGLSurfaceView.TAG, "setAngleX: "+Rotate_X)
    }
    fun setY(yRotateAngle: Int){

        Rotate_Y= (MATH_PI/180.0f * (yRotateAngle % 360)).toFloat()
        Log.d(MyGLSurfaceView.TAG, "setAngleY: "+ Rotate_Y)
    }
    fun setS(scale: Float){
        ScaleXY= (MATH_PI/180.0f * (scale % 360)).toFloat()
        Log.d(MyGLSurfaceView.TAG, "setScale: "+ScaleXY)
    }
    override fun setAngleX(xRotateAngle: Int) {
        setX(xRotateAngle)
    }

    override fun setAngleY(yRotateAngle: Int) {
        setY(yRotateAngle)
    }
    ...
    override fun onDrawFrame(gl: GL10?) {
        ...
        Matrix.rotateM(rotateMatrix, 0,Rotate_X , 1f, 0f, 0f)
        Matrix.rotateM(rotateMatrix, 0, Rotate_Y, 0f, 1f, 0f)
        Matrix.rotateM(rotateMatrix, 0, rotateZ, 0f, 0f, 1f)
        Matrix.scaleM(scaleMatrix, 0, ScaleXY, ScaleXY, scaleZ)
    ...
    override fun onSurfaceChanged(gl: GL10?, width: Int, height: Int) {
        ...
        ratio = (glSurfaceViewWidth/glSurfaceViewHeight).toFloat()
